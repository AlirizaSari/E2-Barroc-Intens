    ...
    internal class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MaintenanceAppointment>().HasData(
                ...
                new MaintenanceAppointment { MaintenanceAppointmentId = 2, CompanyId = 151, Remark = "Koffiezet automaat 2 is ontploft", Added = DateTime.Now, AppointmentDate = null, AppointmentTime = null, AppointmentIsPlanned = false, AssignedEmployee = null, UserId = null, IsRoutineAppointment = false, },
                new MaintenanceAppointment { MaintenanceAppointmentId = 3, CompanyId = 151, Remark = "Koffiezet automaat 3 is de linker tuben kapot", Added = DateTime.Now, AppointmentDate = null, AppointmentTime = null, AppointmentIsPlanned = false, AssignedEmployee = null, UserId = null, IsRoutineAppointment = false, },
                new MaintenanceAppointment { MaintenanceAppointmentId = 4, CompanyId = 151, Remark = "Koffiezet automaat 4 is ontploft", Added = DateTime.Now, AppointmentDate = null, AppointmentTime = null, AppointmentIsPlanned = false, AssignedEmployee = null, UserId = null, IsRoutineAppointment = false, },
                new MaintenanceAppointment { MaintenanceAppointmentId = 5, CompanyId = 152, Remark = "Koffiezet automaat 1 is ontploft", Added = DateTime.Now, AppointmentDate = null, AppointmentTime = null, AppointmentIsPlanned = false, AssignedEmployee = null, UserId = null, IsRoutineAppointment = true, },
                new MaintenanceAppointment { MaintenanceAppointmentId = 6, CompanyId = 152, Remark = "Koffiezet automaat 2 is de linker tuben kapot", Added = DateTime.Now, AppointmentDate = null, AppointmentTime = null, AppointmentIsPlanned = false, AssignedEmployee = null, UserId = null, IsRoutineAppointment = false, },
                new MaintenanceAppointment { MaintenanceAppointmentId = 7, CompanyId = 153, Remark = "Koffiezet automaat 3 is ontploft", Added = DateTime.Now, AppointmentDate = null, AppointmentTime = null, AppointmentIsPlanned = false, AssignedEmployee = null, UserId = null, IsRoutineAppointment = false, },
                new MaintenanceAppointment{ MaintenanceAppointmentId = 8,CompanyId = 154,Remark = "Koffiezet automaat 4 is ontploft",Added = DateTime.Now,AppointmentDate = null,AppointmentTime = null, AppointmentIsPlanned = false, AssignedEmployee = null, UserId = null,IsRoutineAppointment = false,                
                });
